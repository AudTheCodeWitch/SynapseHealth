...
public class NoteParserTests
{
    ...
    [TestMethod]
    public void Parse_ShouldCorrectlyParseFullOxygenNote()
    {
        // Arrange
    ...
    [TestMethod]
    public void Parse_ShouldCorrectlyParseFullCpapNote()
    {
        // Arrange
        const string noteText = """
    ...
    [TestMethod]
    public void Parse_ShouldCorrectlyParseWheelchairNote()
    {
        // Arrange
        const string noteText = """
    ...
    [DataRow("Requires 2.5L of oxygen during sleep.", "sleep", "2.5 L", DisplayName = "Oxygen with sleep usage and liters")]
    public void Parse_ShouldHandlePartialOxygenNotes(string noteText, string expectedUsage, string? expectedLiters)
    {
        // Act
        var result = _parser.Parse(noteText);
    ...
    [DataRow("CPAP with AHI > 28", null, null, "AHI > 28", DisplayName = "CPAP with AHI > 28 qualifier")]
    [DataRow("CPAP with AHI < 28", null, null, "AHI < 28", DisplayName = "CPAP with AHI < 28 qualifier")]
    public void Parse_ShouldHandlePartialCpapNotes(string noteText, string? expectedMask, string? expectedAddon,
    ...
    [TestMethod]
    public void Parse_ShouldUseDefaultValues_WhenNoteIsMinimal()
    {
        // Arrange
    ...
    [TestMethod]
    public void Parse_ShouldDefaultDevice_WhenNotSpecified()
    {
        // Arrange
    ...
    [TestMethod]
    public void Parse_ShouldPrioritizeFirstMatchingDevice_WhenMultipleKeywordsExist()
    {
        // Arrange
